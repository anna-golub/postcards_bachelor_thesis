...
def hamming_distance(x, y):
    ...
    """
    Replacing this with customized distance calculation for imagehash hashes
    """
    return imagehash.hex_to_hash(x) - imagehash.hex_to_hash(y)
...
class BKTree(object):
    ...
    def add(self, item):
        ...
        # customized for imagehash
        # item = imagehash.hex_to_hash(item)
